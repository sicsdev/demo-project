...
const page = () => {
  ...
  const scrollSlug =
    "/blog/chatbot-trends-for-2023-insights-into-latest-innovations-shaping-the-industry";
  useEffect(() => {
    let params =
      "chatbot-trends-for-2023-insights-into-latest-innovations-shaping-the-industry";
