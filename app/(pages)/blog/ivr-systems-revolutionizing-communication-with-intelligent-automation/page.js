...
const scrollSlug = "/blog/ivr-systems-revolutionizing-communication-with-intelligent-automation"
  useEffect(() => {
    let params = "ivr-systems-revolutionizing-communication-with-intelligent-automation";
  ...
  return (
    ...
    <div className="sm:w-[70%]">
      ...
      ></p>
      <h1  id={single?.acf?.heading6} className=" font-bold  text-1xl  md:text-h4 lg:text-h5 sm:text-h4 sm:leading-none ">
        {single?.acf?.heading6}
      </h1>
      <p
        className=" text-base sm:text-para md:text-para lg:text-para sm:leading-8 my-2 sm:my-6 font-base text-heading"
            ...
            <div className=" ml-4  font-medium SideOptions">
                ...
                >
                 ...
                 {single?.acf?.heading2}
                  ...
                  </Link><Link href={`${scrollSlug}#${single?.acf?.heading3}`}>
                    <p
                 ...
                 {single?.acf?.heading3}
                  ...
                  </Link><Link href={`${scrollSlug}#${single?.acf?.heading4}`}>
                    <p
                 ...
                 {single?.acf?.heading4}
                  ...
                  </Link><Link href={`${scrollSlug}#${single?.acf?.heading5}`}>
                    <p
                 ...
                 {single?.acf?.heading5}
                  ...
                  </Link><Link href={`${scrollSlug}#${single?.acf?.heading6}`}>
                    <p
