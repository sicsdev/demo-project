      ...
      {success === false && (
        <Container>
          ...
          <div className="w-full sm:max-w-[70%] md:max-w-[53%%] lg:max-w-[40%] mx-auto">
            <div className=" text-center sm:mt-14 border border-gray p-6 bg-white shadow-login-page rounded-sm float-left w-full clear-both">
