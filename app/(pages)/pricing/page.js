        ...
        <div className="bg-white">
          ...
          <div className="w-full sm:w-[60%]  md:w-[60%] lg:w-[60%]  grid grid-cols-1 align sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 my-4 gap-4 mx-auto js-show-on-scroll">
                      ...
                      >
                        ...
                        {hide.first == true ? (
                          ...
                          >
                            ...
                            >
                              * Resolution is any conversation that does not result in a human hand off or a customer marks as a bad answer and has at least 3 total interactions.
                            </p>
                          </Card>
                        ) : (
                          ""
            ...
            `,
                    ...
                    className="flex w-full font-bold mx-auto mt-7 justify-center px-4 py-2 text-white hover:border hover:bg-white hover:text-black bg-black rounded-md shadow-sm"
                  ></Button>
                )}
              </Card>
            ))}
