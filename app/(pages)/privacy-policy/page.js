            ...
            <div className=" bg-white py-4 ">
                <div className="my-8 mx-auto max-w-[80%]">
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        TempoAIVentures,Inc.(“Tempo”“we,” “us,” or “our”) respect your privacy. This Privacy Notice describes the processing of Personal Information (defined below) that is provided, collected, or shared on our websiteand any other sites that link to this Privacy Notice(collectively, the “Site”). It also describes rights you may have under applicable laws.
                    </p>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        This Noticedoes not apply to Personal Information (defined below)that we process on behalf of enterprise customersthat integrate our chat-bot services or other business offerings (“Services”). When you interact with  us  through  our  enterprise  customers,  your  Personal  Information  is collected,  used,  and  processed accordingto their privacy policy.
                    </p>
                    <h2 className="text-lg sm:text-lg md:text-lg lg:text-lg sm:leading-8 my-2 sm:my-6 font-semibold text-heading">
                    ...
                    <ul>
                        <li className='text-base'>
                            <p><span className='font-bold'>Contact Information</span> – If you submit an inquiry, register for an account, request a free demo, or provide information on our Site we may collect your contact information. This may include your name, address, email address, demographic information, and phone number.</p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Commercial information</span> – This includes information about purchases, information about subscriptions, products and services you have shown interest in, payment processing information, and other commercial information.</p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Usage Information</span> – When you use our Site, our servers may automatically record information, including your Internet Protocol address (IP Address), geolocation of your device, browser type, referring URLs (e.g., the site you visited before coming to our Site), domain names associated with your internet service provider, or other information regarding your interaction with the Site.</p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Communication Information</span> – We may collect the contents of your communications with us, whether via e-mail, social media, telephone or otherwise, and inferences we may make from other Personal Information we collect. Where permitted by applicable law, we may collect and maintain records of calls and chats with our agents, representatives, or employees via message, chat, post, or similar functionality.</p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li className='text-base'>
                            <p><span className='font-bold'>Directly From You</span> – For example, if you choose to contact us or request information from us.</p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>From Third Parties</span> – For example, we may work with business partners, subcontractors, advertising networks, analytics providers, and search information providers, who may provide us with Personal Information about you. </p>
                        </li>

                        <li className='text-base'>
                            <p><span className='font-bold'>Online Tracking Technologies</span> – We may use cookies and similar technologies such as pixels, web beacons, and local storage to collect Personal Information related to online activities. For additional information regarding our use of these technologies, see section 5 below.</p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li className='text-base'>
                            <p>respond to reviews, comments, or other feedback provided to us;  </p>
                        </li>
                        <li className='text-base'>
                            <p>enhance, support, and personalize the Site and our advertising or marketing efforts;  </p>
                        </li>
                        ...
                        <li className='text-base'>
                            <p>comply with applicable legal or regulatory requirements and our policies; and   </p>
                        </li>
                        <li className='text-base'>
                            <p>the extent necessary for any other lawful purpose for which the Personal Information is collected.    </p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li className='text-base'>
                            <p><span className='font-bold'>Business Partners</span> – We may share Personal Information with trusted business partners or corporate affiliates. </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Legal Obligation or Safety Reasons</span> – When we have a good faith belief that access, use, preservation or disclosure of Personal Information is reasonably necessary to (a) satisfy or comply with any requirement of law, regulation, legal process, or enforceable governmental request, (b) enforce or investigate a potential violation of any agreement you have with us, (c) detect, prevent, or otherwise respond to fraud, security or technical concerns, (d) support auditing and compliance functions, or (e) protect the rights, property, or safety of Tempo, its users, or the public against harm. </p>
                        </li>

                        <li className='text-base'>
                            <p><span className='font-bold'>Merger or Change of Control</span> – If we are involved in a merger, acquisition, or any other transaction involving a change of control in our business including but not limited to a bankruptcy or similar proceeding, Personal Information may be transferred along with the business. Where legally required, we will give you prior notice prior to such a transfer. </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Service Providers</span> – We share your Personal Information with third party service providers as necessary to enable them to support the Site, or other aspects of our business. </p>
                        </li>
                    </ul>
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        We collect Personal Information and other data from cookies, pixel tags, and tracking technologies. We allow or enable third parties to collect Personal Information to provide their interest-based advertising services.
                    </p>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                    ...
                    <ul>
                        <li className='text-base'>
                            <p><span className='font-bold'>Access:</span> – You may have the right to know what Personal Information we have collected about you and to access such data. </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Data portability:</span> – You may have the right to receive a copy of your information in a portable and readily usable format. </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Deletion:</span> –You may have the right to delete your Personal Information that we have obtained, subject to certain exceptions.  </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Correction:</span> – You may have the right to correct inaccuracies in your Personal Information. </p>
                        </li>
                        <li className='text-base'>
                            <p><span className='font-bold'>Opt out of certain processing:</span> – You may have the right to opt out of the processing of your information for purposes of (a) targeted advertising, (b), the sale of your Personal Information; or (c) profiling in furtherance of decisions that produce legal or similarly significant effect concerning you.  </p>
                        </li>
                    </ul>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        To exercise any of the privacy rights afforded to you, please submit a request to us by emailing us at privacy@usetempo.ai.
                    </p>
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        If you are a California resident, California law provides you with specific rights regarding your Personal Information. Any capitalized terms not defined in this Privacy Policy have the meanings set forth in the California Consumer Privacy Act of 2018 (the “CCPA”) as amended by the California Privacy Rights Act (the “CPRA”).
                    </p>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        Within the last twelve (12) months, we have collected the categories of Personal Information listed in the table below. The table also lists, for each category: (1) the categories of third parties (if any) to which we disclosed Personal Information in the preceding 12 months; (2) whether the Personal Information was sold or shared with third parties; and (3) the applicable retention period for each category of Personal Information.
                    </p>
                    ...
                    {/* <table className="ml-auto mr-auto mt-5 sm:mt-0 text-sm text-left text-gray-500 dark:text-gray-400 sm:w-[40%] mx-6 sm:mx-auto m-auto shadow-lg">
                            ...
                            <tr>
                                ...
                                >
                                   Categories of Third Parties to Which We Disclose Personal Information for a Business or Commercial Purpose
                                    ...
                                    className="px-6 py-3 bg-[#09162A] text-white rounded-tr-lg text-center"
                                >
                                   Categories of Third Parties to Which We May Sell or Share Personal Information
                                </th>
                                                                <th
                                    scope="col"
                                    className="px-6 py-3 bg-[#09162A] text-white rounded-tr-lg text-center"
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td className="px-6 py-4">asdsd</td>
                            </tr>
                            <tr
                            ...
                            >
                                ...
                                <td className="px-6 py-4">sdasd</td>
                            </tr>
                            <tr
                                className="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-center"
                                style={{ borderBottom: "1px solid rgb(220 222 225 / 55%)" }}
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        When we receive your request to exercise your rights described in this Privacy Policy, we will (a) acknowledge receipt of your request; (b) try to match the information you provide in making the request with information we already maintain about you; (c) if required to verify your identity, ask you to provide additional information, including personal data; and (d) consider various factors when determining how to verify your identity, such as the sensitivity and value of the data, the risk of harm, the likelihood of fraud, etc.
                    </p>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        We will not deny access to our services, provide different prices or rates for our services, or provide a different level or quality of services to you based solely on your decision to exercise your rights listed in this Notice.
                    </p>
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        This Privacy Notice is available to consumers with disabilities. To access this Privacy Notice in an alternative downloadable format, please go to https://usetempo.ai/privacy-policy-pdf.
                    </p>
                    ...
                    <p className="text-base sm:text-base mb-3 ">
                        {" "}
                        If you have any questions about our practices or this Privacy Notice, please contact us at privacy@usetempo.ai.
                    </p>
                </div>
            </div>
        </div>
