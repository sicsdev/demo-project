...
const page = () => {
  ...
  const scrollSlug = "/article/front-integration";
  useEffect(() => {
    let params = "front-integration";
    ...
    <div className="block sm:flex md:flex lg:flex justify-evenly items-center gap-5">
      ...
      {loading ? (
        ...
        {loading ? (
          ...
          <h1 className="font-bold  sm:mt-0 mt-[2rem] text-3xl text-heading  md:text-h2 lg:text-h3 sm:text-h2 sm:leading-none">
...
{loading ? (
        ...
        {loading ? (
          <h1 className="font-bold  px-4 pt-8 text-3xl text-heading  md:text-h2 lg:text-h3 sm:text-h2 sm:leading-none">
            <SkeletonLoader className="sm:h-[70px] sm:w-[800px]" />
          </h1>
        ) : (
          <p
