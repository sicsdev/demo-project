...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      SendGrid Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution harnesses your SendGrid data to craft AI-driven smart workflows, revolutionizing your email delivery and tracking experience.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to SendGrid is seamless, facilitating interfaces to oversee your email campaigns and analytics. This could promote higher deliverability, automated responses, or A/B testing insights.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/sendgrid-integration">
              Tempo + SendGrid integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/sendgrid-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>SendGrid Workflow Use Cases</h5>
            </div>
          </div>
        </div>
