...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Calendly Connects with Tempo   </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution employs your Calendly data to craft AI-driven smart workflows, elevating your scheduling capabilities
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Calendly is simple, allowing for user interfaces that oversee your appointment data. This could enable automation for reminders, re-scheduling, or time zone adjustments.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="article/calendly-integration">
              Tempo + Calendly integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/calendly-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>Calendly Workflow Use Cases</h5>
            </div>
          </div>
        </div>
