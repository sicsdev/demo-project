...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Twilio Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution capitalizes on your Twilio data to create AI-powered smart workflows, elevating your communication solutions via voice, SMS, and more.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Twilio is straightforward, facilitating interfaces that manage communication logs and integrations. This could offer automated responses, streamlined notifications, or enhanced customer interactions.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/twilio-integration">
              Tempo + Twilio integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/twillio-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>Twilio Workflow Use Cases</h5>
            </div>
          </div>
        </div>
