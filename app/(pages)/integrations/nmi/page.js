...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      NMI Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution engages with your NMI data to develop AI-driven smart workflows, refining your payment gateway experience.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to NMI is a breeze, facilitating interfaces that manage transactional data. This could provide tools for payment processing, fraud monitoring, or subscription handling.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/nmi-integration">
              Tempo + NMI integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/nmi-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
