        ...
        <div>
          <div className="flex  justify-center gap-[1rem] items-center flex-col sm:flex-row sm:gap-[80px]  sm:justify-between my-[21px] sm:my-0">
            ...
            {loading ? (
              ...
              <img src="/menu_logo.png" className="w-[120px] h-[120px]"></img>
            )}
            </div>
          </div>
          ...
          <div className="text-left sm:mt-7 p-[24px] sm:p-0">
            ...
            {loading ? (
             ...
             " Streamline Your Payment Processing and Customer Management with Real-Time Data Sync"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Seamlessly manage all your billing endpoints, issue refunds, and handle subscriptions directly from Tempo's unified dashboard."
            )}
            </p>
            ...
            {loading ? (
              ...
              "Leverage Tempo's automation features to add, update, or delete customers in your NMI account effortlessly."
  )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[30px] text-xl">
            {loading ? (
            ...
            <p className="text-heading text-xl">
              Utilize Tempo's analytics to gain actionable insights from your
              NMI data, enabling smarter business decisions.{" "}
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              Integrate your NMI account with Tempo in a few simple steps.{" "}
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-[#363866] !font-semibold   text-xl">
              2. Customize Your Payment Workflow with NMI Endpoints:
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              Incorporate NMI's diverse API endpoints into your Tempo workflows
              for a tailored payment processing experience.{" "}
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              Use Tempo's analytics to derive valuable insights from your NMI
            ...
            {loading ? (
              ...
              <img
                src="/integration_page/NMI_tab-1.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Transaction Management: </b> Create, capture, and refund
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Recurring Billing: </b>Manage all aspects of your recurring billings, from creation to deletion.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Customer Operations:</b> Add, update, and delete customers
              directly from Tempo
            </p>
            )}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/nmi_tab2.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
            Ready to optimize your payment processing and customer management? Integrate NMI with Tempo today.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
