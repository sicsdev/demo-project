      ...
      />
              ...
              <p className="text-[#363866] !font-semibold sm:mb-3 text-xl">
                {loading ? (
                  ...
                  "Why Integrate GitHub with Tempo?"
                )}
              </p>
              <p className="text-[#363866] !font-semibold sm:mb-3 text-xl">
                {loading ? (
              ...
              {loading ? (
                <SkeletonLoader count={4} height={20} width="100%" />
              ) : (
                <p className="text-heading text-xl sm:mb-3">
                  <b>Holistic Development Management:</b> Combine GitHub's
                  repository, issue, and pull request management with Tempo's
                  robust workflow features for a comprehensive development
                  solution.
                </p>
              )}
              {loading ? (
                ...
                <p className="text-heading text-xl sm:mb-3">
                  <b> Unified Control Panel:</b> Manage GitHub repositories,
                  issues, and pull requests directly within Tempo's interface.
                </p>
              )}
              {loading ? (
                <SkeletonLoader count={1} height={20} width="100%" />
                ...
                <p className="text-heading text-xl sm:mb-3">
                  <b>Data-Driven Decisions:</b> Utilize Tempo's analytics to make
                  informed decisions based on your GitHub data.
                </p>
              )}
              <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[30px] text-xl">
                {loading ? (
              ...
              <p className="text-heading text-xl sm:mb-3">
                {loading ? (
                  ...
                  "Seamlessly integrate your GitHub account with Tempo in just few clicks."
                )}
              </p>
              <p className="text-[#363866] !font-semibold text-xl">
                {loading ? (
                  ...
                  "2. Customize Your Workflow with GitHub Endpoints"
                )}
              </p>
              <p className="text-heading text-xl sm:mb-3">
                {loading ? (
                  ...
                  "Incorporate GitHub's versatile endpoints into your Tempo workflows."
                )}
              </p>
              <p className="text-[#363866] !font-semibold  text-xl">
                {loading ? (
              ...
              <p className="text-heading text-xl sm:mb-3">
                {loading ? (
                  ...
                  "Leverage Tempo's analytics to gain actionable insights from your GitHub data, enabling continuous development improvement."
                )}
              </p>
              <div>
                {loading ? (
                  ...
                  <img
                    src="/integration_page/Github_tab-1.png"
                    className="w-[full] sm:[465px] sm:h-[465px]"
                  />
                )}
              </div>
              ...
              {loading ? (
                ...
                <p className="text-heading text-xl sm:mb-3">
                  <b>Pull Request Management:</b> Create, update, and manage pull
              ...
              {loading ? (
                ...
                <p className="text-heading text-xl sm:mb-3">
                  <b> Issue Tracking:</b> Keep tabs on all your issues and their
                  statuses.
                </p>
              )}
              {loading ? (
                ...
                <p className="text-heading text-xl sm:mb-3">
                  <b> Project Oversight:</b> Manage all aspects of your GitHub
                  projects from within Tempo.
                </p>
              )}
              <div>
                {loading ? (
                  ...
                  <img
                    src="/integration_page/Github_tab2.png"
                    className="w-[full] sm:[465px] sm:h-[465px]"
                  />
                )}
              </div>
              ...
              <p className="text-heading text-xl sm:mb-3">
                {loading ? (
                  ...
                  "Ready to take your software development workflow to the next level? Integrate GitHub with Tempo today."
                )}
              </p>
              <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[50px] text-xl">
                {loading ? (
