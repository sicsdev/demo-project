        ...
        <div>
          <div className="flex  justify-center gap-[1rem] items-center flex-col sm:flex-row sm:gap-[80px]  sm:justify-between my-[21px] sm:my-0">
            <div className=" flex flex-col justify-evenly">
              ...
              "Jira Software Integration with Tempo"
              )}
              </p>
            ...
            <img src="/Jira.png" className="w-[120px] h-[120px]"></img>
            )}
            </div>
          </div>
          <div className="text-left sm:mt-7 p-[24px] sm:p-0">
            ...
            "Unleash the Full Potential of Agile Project Management"
            )}
            </p>
          ...
          {/* <div>
            ...
            "Why Integrate Jira Software with Tempo?"
            )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 text-xl">
            {loading ? (
            ...
            "Integrate Jira Software's robust agile capabilities with Tempo's Workflow Builder for a seamless agile development cycle."
            )}
            </p>
            ...
            "Manage all your Jira Software projects, issues, and components directly from Tempo’s unified interface."
            )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[30px] text-xl">
            {loading ? (
            ...
            "Utilize Tempo's Learning Center to analyze real-time metrics from your Jira Software projects for smarter decision-making."
            )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[30px] text-xl">
            {loading ? (
            ...
            {loading ? (
              ...
              "1. Connect Jira Software to Tempo's Workflow Builder"
            )}
            </p>
            ...
            "Seamlessly integrate your Jira Software account with Tempo in a few simple steps."
            )}
            </p>
            ...
            {loading ? (
              ...
              "2. Customize Your Workflow with Jira Endpoints"
            )}
            </p>
            <p className="text-heading text-xl sm:mb-3">
            {loading ? (
            ...
            "Add Jira Software endpoints to your Tempo workflow for a tailored project management experience."
            )}
            </p>
            <p className="text-[#363866] !font-semibold  text-xl">
            {loading ? (
            ...
            "Leverage Tempo’s Learning Center to gain insights into your Jira Software projects and optimize them based on real-time data."
            )}
            </p>
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/Jira_tab-1.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Issue Management:</b> Create, update, and delete issues with ease.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Project Overview:</b> Access details and lists of all your Jira Software projects.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Component and Status Tracking:</b> Get a comprehensive view of all components and statuses for each project.
            </p>
            )}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/Jira_tab2.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            "Ready to elevate your agile project management? Integrate Jira Software with Tempo today."
            )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[50px] text-xl">
            {loading ? (
