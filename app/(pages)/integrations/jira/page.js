...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Jira Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution utilizes your Jira data to establish AI-driven smart workflows, transforming your issue and project tracking experience.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Jira is smooth, enabling interfaces to manage tasks and project data. This might streamline ticketing, sprint planning, or backlog prioritization.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/jira-integration">
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/jira-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
