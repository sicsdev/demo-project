...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Microsoft Teams Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution exploits your Microsoft Teams data to create AI-driven smart workflows, optimizing your team collaboration and communication.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Microsoft Teams is effortless, allowing interfaces that manage chat and meeting data. This could promote streamlined communication, automated reminders, or meeting scheduling.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/microsoft-teams-integration">
              Tempo + Microsoft Teams integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/ ms-team-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>Microsoft teams Workflow Use Cases</h5>
            </div>
          </div>
        </div>
