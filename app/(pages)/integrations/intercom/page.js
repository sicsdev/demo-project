        ...
        <div>
          <div className="flex  justify-center gap-[1rem] items-center flex-col sm:flex-row sm:gap-[80px]  sm:justify-between my-[21px] sm:my-0">
            <div className=" flex flex-col justify-evenly">
              ...
              {loading ? (
                ...
                "Intercom Integration with Tempo"
              )}
              </p>
          ...
          <div className="text-left sm:mt-7 p-[24px] sm:p-0">
            ...
            {loading ? (
              ...
              "Elevate Your Customer Support and Engagement with Real-Time Data Sync"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Why Integrate Intercom with Tempo?"
              )}            </p>
              {loading ? (
                <SkeletonLoader count={1} height={20} width="100%" />
              ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Unified Customer Dashboard:</b> Manage all your customer interactions, from support to sales, directly from Tempo's centralized interface.
            </p>
              )}
              {loading ? (
                <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Automated Workflows:</b> Utilize Tempo's workflow automation to streamline your Intercom operations, such as user management and conversation tracking.
            </p>
              )}
              {loading ? (
                <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Data-Driven Decisions:</b> Leverage Tempo's analytics to gain actionable insights from your Intercom data, enabling smarter customer engagement strategies.
            </p>
              )}
              {loading ? (
                <SkeletonLoader count={1} height={20} width="50%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Connect Intercom to Tempo:</b> Seamlessly integrate Intercom with Tempo in just a few clicks.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Customize Your Customer Support Workflow with Intercom Endpoints:</b> Incorporate Intercom's diverse endpoints into your Tempo workflows for tailored customer support and engagement.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Analyze and Optimize:</b> Use Tempo's analytics to derive valuable insights from your Intercom data, driving continuous improvement.
            </p>
            )}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/Intercom_tab-1.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>User Management:</b> Create, update, and manage users and contacts effortlessly.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b> Conversation Tracking:</b>Keep track of all your customer conversations and their statuses in real-time.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Help Center Management:</b> Easily manage articles, collections, and sections in your Intercom Help Center.
            </p>
            )}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/Intercom_tab2.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              Ready to take your customer support and engagement to the next level? Integrate Intercom with Tempo today.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
