...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Intercom Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution leverages your Intercom data to generate AI-driven smart workflows, enhancing your real-time customer communication.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Intercom is straightforward, allowing for interfaces that manage chat and support data. This could elevate customer engagement, automate responses, or segment user conversations.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/intercom-integration">
              Tempo + Intercom integration&nbsp;
              </Link>
            </span>
        ...
        <div className="w-full sm:w-[60%] p-4">
          <div className=" w-full relative overflow-hidden">
            <img className="" src="/integration_page/intercom-page-top.png" />
          </div>
        </div>
      </div>
      {/* card section */}
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>Intercom Workflow Use Cases</h5>
            </div>
          </div>
        </div>
