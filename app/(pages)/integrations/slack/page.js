...
const page = () => {
  return (
    <div className="bg-white pb-6">
      ...
      Slack Connects with Tempo      </h1>
      <p className=" text-xl text-left px-4 sm:text-center m-auto md:text-xl sm:max-w-[600px] pb-6 text-heading">
      Our solution taps into your Slack data to produce AI-driven smart workflows, optimizing your team communication and collaboration.
      </p>
      ...
      <div className="flex  items-center flex-col-reverse sm:flex-row">
        <div className="w-full sm:w-[40%] p-4">
          ...
          Connecting Tempo to Slack is simple, allowing for interfaces that handle chat data and integrations. This could foster channel organization, automated notifications, or integration with other tools.
          </p>
          <p className="text-black sm:mb-5">
            Read the Refer to the&nbsp;
            <span className="text-primary font-semibold">
              <Link href="/article/slack-integration">
              Tempo + Slack integration&nbsp;
              </Link>
            </span>
        ...
        <div className="max-w-sm rounded overflow-hidden ">
          <div className="">
            <div className="text-heading text-2xl font-semibold mb-2 sm:mb-7">
              <h5>Slack Workflow Use Cases</h5>
            </div>
          </div>
        </div>
