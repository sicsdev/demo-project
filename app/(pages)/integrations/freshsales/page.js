        ...
        <div>
          <div className="flex  justify-center gap-[1rem] items-center flex-col sm:flex-row sm:gap-[80px]  sm:justify-between my-[21px] sm:my-0">
            <div className=" flex flex-col justify-evenly">
              ...
              {loading ? (
                ...
                "Tempo Integrates with Freshsales"
              )}
              </p>
            ...
            {loading ? (
              ...
              <img src="/fresh.png" className="w-[120px] h-[120px]"></img>
            )}
            </div>
          </div>
          <div className="text-left sm:mt-7 p-[24px] sm:p-0">
            ...
            {loading ? (
              ...
              "Supercharge Your CRM Operations with Real-Time Data and Analytics"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Why Integrate Freshsales with Tempo?"
            )}
            </p>
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Unified Dashboard:</b>Manage Freshsales contacts, accounts,
              deals, and sales activities directly from Tempo's interface.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Data-Driven Decisions:</b>Leverage Tempo's analytics to make
              informed decisions in your CRM operations.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Automated Workflows:</b>Create, update, and delete CRM entities
              effortlessly with automated workflows.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Connect Freshsales to Tempo:</b>Seamlessly integrate your
              Freshsales account with Tempo in just a few clicks.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Customize Your CRM Workflow:</b> Utilize Freshsales' API
              endpoints to tailor your CRM operations to your specific needs.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Analyze and Optimize:</b>Use Tempo's analytics to continuously
              improve your CRM strategies.
            </p>
            )}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/FreshSales_tab-1.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Contact Management:</b>Create, view, update, and delete
              contacts.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Account Operations:</b>Handle all your accounts, including
              creation, viewing, updating, and deletion.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ) : (
            <p className="text-heading text-xl sm:mb-3">
              <b>Deal Tracking:</b>Manage your sales deals effectively from
              creation to closure.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Sales Activities:</b> Create and manage sales activities for a
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>User and Lead Management:</b> Create, update, and manage users
              and leads for a holistic CRM experience.
            </p>
            )}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="100%" />
            ...
            <p className="text-heading text-xl sm:mb-3">
              <b>Sales Sequences:</b> Create and manage sales sequences for
              automated outreach.
            </p>)}
            <div>
            {loading ? (
              ...
              <img
                src="/integration_page/FreshSales_tab2.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            {loading ? (
             ...
             " Ready to take your CRM operations to the next level? Integrate Freshsales with Tempo today."
            )}
            </p>
            <p className="text-[#363866] !font-semibold sm:mb-3 sm:mt-[50px] text-xl">
            {loading ? (
