...
const page = () => {
  ...
  return (
        ...
        <div>
          ...
          <div className="flex  justify-center gap-[1rem] items-center flex-col sm:flex-row sm:gap-[80px]  sm:justify-between my-[21px] sm:my-0">
            ...
            <div className=" flex flex-col justify-evenly">
              ...
              {loading ? (
                ...
                "Datadog Integration with Tempo"
              )}
              </p>
            ...
            {loading ? (
              ...
              <img src="/datadog-logo-purple.png" className="w-[120px] h-[120px]"></img>
            )}
            </div>
          ...
          <div className="text-left sm:mt-7 p-[24px] sm:p-0">
            ...
            {loading ? (
              ...
              "Elevate Your Observability and Performance Monitoring with Tempo's Workflow Automation"
            )}
            </p>
            ...
            {loading ? (
             ...
             " Why Integrate Datadog with Tempo?"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Combine Datadog's comprehensive monitoring capabilities with Tempo's Workflow Builder to create a unified observability platform."
            )}
   ...
   "           Leverage Tempo's Learning Center to optimize your monitoring workflows based on real-time analytics and recommendations."
            )}
            ...
            {loading ? (
              ...
              "1. Connect Datadog to Tempo's Workflow Builder"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Seamlessly integrate your Datadog account with Tempo's Workflow Builder.     "
                   )}       </p>
         ...
         "     2. Select and Add Datadog Endpoints"
            )}
            </p>
            ...
            {loading ? (
              ...
              "Choose from a variety of Datadog endpoints to create custom monitoring and observability workflows.")}
            </p>
         ...
         "     Gain actionable insights from Tempo's Learning Center to continually enhance your monitoring strategies."
            )}
            ...
            {loading ? (
              ...
              <img
                src="/integration_page/DataDog_tab_1.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            <p className="text-heading text-xl sm:mb-3">
              ...
              <b>Timeboard Management:</b> Create, execute, and Timeboards.
            ...
            <p className="text-heading text-xl sm:mb-3">
              ...
              <b> Event Handling:</b>  Post new events and query the event stream.
            </p>)}
            {loading ? (
              <SkeletonLoader count={1} height={20} width="60%" />
            ) : (
            ...
            <p className="text-heading text-xl sm:mb-3">
              ...
              <b> Detailed Monitoring:</b>  Retrieve details of specific Timeboards and events.
            </p>
            )}
            ...
            {loading ? (
              ...
              <img
                src="/integration_page/DataDog_tab2.png"
                className="w-[full] sm:[465px] sm:h-[465px]"
              />
            )}
            </div>
            ...
            {loading ? (
              ...
              "Ready to elevate your observability and performance monitoring? Integrate Datadog with Tempo today."
            )}
            </p>
