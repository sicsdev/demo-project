        ...
        <div className="mx-auto max-w-[90%] sm:max-w-[80%] md:max-w-[80%] lg:max-w-[80%] py-10">
          ...
          <div className="relative sm:max-w-[30%] mt-6 m-auto">
            <input
              ...
              className={
                "border border-border shadow-none block px-2 bg-white  rounded-md text-lg placeholder-slate-400 text-black  focus:outline-none focus:border-sky focus:ring-2 isabled:bg-slate-50 disabled:text-slate-500 w-full focus:bg-white focus:text-[12px] pl-10"
              }
              id={"search"}
            />
            <img
