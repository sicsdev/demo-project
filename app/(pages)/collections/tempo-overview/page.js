...
const page = () => {
  ...
  return (
    <div className='bg-[white]  px-[20px] sm:px-0  sm:pl-[10%] pb-[83px]'>
        <div>
<h2 className='font-bold  px-4 pt-8 text-3xl text-heading  md:text-h2 lg:text-h3 sm:text-h2 sm:leading-none'>Deflection AI Overview</h2>
<div className='border-2 rounded-lg mt-[60px] w-[68rem] px-3 py-2'>
    {/* {single?.map((ele,key)=> */}
   <Link href="/article/what-is-tempo"> <p  className="m-4  px-3 py-2 text-xl text-heading  md:text-h2 lg:text-lg sm:text-h2 sm:leading-none hover:bg-backhover">What is Deflection AI?</p></Link>
