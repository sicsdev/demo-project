...
const Subprocessor = () => {
  ...
  return (
    <>
      <div class="relative overflow-x-auto sm:rounded-lg mx-6 sm:mx-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 m-auto shadow-lg">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              {data.map((ele, key) => (
                <th scope="col" class="px-3 sm:px-6 py-2 sm:py-4 bg-[#09162A] text-white" key={key}>
                  {ele}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            {subprocessors.map((ele, key) => (
              ...
              >
                <th
                  scope="row"
                  class="px-3 sm:px-6 py-2 sm:py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                >
                  {ele.name}
                </th>
                <td class="px-3 sm:px-6 py-2 sm:py-4">{ele.processing}</td>
                <td class="px-3 sm:px-6 py-2 sm:py-4">{ele.location}</td>
