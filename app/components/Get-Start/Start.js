        ...
        <div className='bg-background'>
            <div className=' mx-auto max-w-[90%] sm:max-w-[80%] md:max-w-[80%] lg:max-w-[80%]  py-10'>
                <div className='block sm:flex md:flex lg:flex justify-evenly items-center'>
                    <div className=''>
                        <h1 className=" font-bold  text-2xl  bg-gradient-to-r from-voilet via-yellow to-white lg:leading-none  text-transparent bg-clip-text md:text-5xl lg:text-5xl sm:text-5xl">
