    ...
    <>
      <div className="bg-home-above relative h-[700px]">
        <div className="absolute w-[65%] h-full flex right-0">
          <img src="/new-right-side.png" className="object-fill w-full md:opacity-[.5]	opacity-[0.4]" />
        </div>
        <div className="absolute w-[65%] h-full flex left-0">
        <img src="/new-light-side.png" className="object-fill w-full md:opacity-[.5]	opacity-[0.4]" />
      </div>
