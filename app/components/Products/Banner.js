...
const banner = ({ handleClickScroll }) => {
  ...
  const customStyles = {
    ...
    backgroundImage: `url('../solutions_/chatbot.png')`,
    ...
    >
      <div className="w-auto sm:p-14 relative p-4 sm:w-[1450px] mx-auto App w-full">
        ...
        {loading ? (
          ...
          <div className="block sm:flex md:flex lg:flex gap-4 sm:px-0 items-center mt-8 sm:mb-8 cursor-pointer">
            <Link
              href={`/checkout`}
              className={
