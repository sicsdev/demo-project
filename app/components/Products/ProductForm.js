...
const ProductForm = ({ reference }) => {
  ...
  }, [fullname,business,phone, company, employe, country, state]);
    ...
    <>
      {show == false ? (
                ...
                <div className=" mx-auto text-center">
                    ...
                    {loading ? (
                      ...
                      <>
                        <input
                          ...
                          value={fullname.data}
                          onChange={(e) =>
                            setFullName({ data: e.target.value })
                          }
                          className={
                    ...
                    {loading ? (
                      ...
                      <>
                        <input
                          ...
                          value={business.data}
                          onChange={(e) =>
                            setBusinnes({ data: e.target.value })
                          }
                          className={
                            "mb-3 border border-input_color w-full block  px-2 py-3 sm:px-3 sm:py-4 bg-white  rounded-2xl text-sm shadow-sm placeholder-slate-400  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500"
                          }
                  ...
                  {loading ? (
                    ...
                    <button
                      ...
                      className={
                        `flex items-center  justify-center h-[62px] sm:h-[45px] r text-center getademo_animation   border ${disabled ? "bg-[#fe9327] text-white cursor-pointer":"bg-white !text-[#fe9327]"} !border-[#fe9327] w-full py-2 sm:py-[20px] px-3 sm:w-[150px] text-[20px] font-semibold focus:ring-yellow-300 text-white rounded-2xl `
                      }
        ...
        <div className="block">
          ...
          <p className="text-center text-[30px] text-bold my-5">
            {" "}
            We've Got It!
          </p>
