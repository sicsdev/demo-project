                    ...
                    <div className=''>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 my-12'>
                            <Card className={'cursor-pointer hover:bg-card_bg border border-border'} onClick={()=>{setSelect(0)}}>
                                <div>
                                    <div className="flex items-center mr-4">
                                        <input id="purple-radio" type="radio" value={select} name="colored-radio" className="w-4 h-4 text-voilet bg-voilet border-gray-300 dark:ring-offset-gray-800 focus:ring-2 dark:bg-voilet dark:border-gray-600" checked={select === 0}   />
                            ...
                            <Card className={'cursor-pointer hover:bg-card_bg border border-border'} onClick={()=>{setSelect(1)}}>
                                <div>
                                    <div className="flex items-center mr-4">
                                        <input id="purple-radio" type="radio" value={select} name="colored-radio" className="w-4 h-4 text-voilet bg-voilet border-gray-300 dark:ring-offset-gray-800 focus:ring-2 dark:bg-voilet dark:border-gray-600" checked={select === 1}  />
                                        <label htmlFor="purple-radio" className="ml-2 text-lg font-semibold text-gray-900 dark:text-gray-300">Guru</label>
                                    </div>
