...
const ManageKnowledgeBase = ({ viewKnowledgeCenterHandler }) => {
    ...
    const knowledgeCenterColumns = [
        ...
        },
        {
            ...
            reorder: true,
            cell: (row) => (
                <span data-tag="allowRowEvents" className="inline-block whitespace-nowrap rounded bg-[#d8efdc] text-[#107235] px-4 py-2 align-baseline text-xs font-bold leading-none">
                    {row.state}
                </span>
            ),
        },
    ...
    return (
        <>
                ...
                <div className="sm:flex rounded-t-lg pt-4 sm:pt-4 p-2 sm:p-5 border-border justify-between items-center">
                    <div className="flex justify-between items-center gap-4 w-full sm:w-1/4">
                        <div className='flex justify-between items-center gap-1'>
                            ...
                            <h3 className="text-normal font-bold text-heading">Fin Content</h3>
                        </div>
                    </div>
                    <div className='flex flex-wrap sm:justify-end items-center gap-2 w-full sm:w-3/4'>
                        <div>
                            <button type="button" className="flex items-center justify-center gap-2 focus:ring-4 focus:outline-none font-bold rounded-md text-sm py-2.5 px-4 focus:ring-yellow-300 text-black bg-[#ececf1] hover:text-white hover:bg-black disabled:bg-input_color disabled:text-white w-auto">
            ...
            {createModal === true && (
                <Modal title={'Add new Fin Content'} show={createModal} setShow={setCreateModal} showCancel={true} className={"w-[100%] sm:w-[50%] md:w-[50%] lg:w-[50%] my-6 mx-auto sm:max-w-[50%] md:max-w-[50%] lg:max-w-[50%]"} >
                    <div className='block sm:flex justify-center items-center gap-4 py-4'>
                        <div onClick={() => handleCreateOptions('snippet')} className='my-2 bg-white p-5 shadow-[0_0_10px_0px_#00000014] hover:shadow-[0_0_10px_0px_#00000054] rounded-lg cursor-pointer w-full sm:w-1/3'>
                            <DocumentTextIcon className='h-10 w-10 text-white bg-[#30bdc6] rounded-lg p-2' />
                            <h3 className='text-sm text-black hover:text-primary font-bold py-4'>Snippet</h3>
                            <p className='text-xs font-normal'>Plain text content specific for Fin, not publicly available</p>
                        </div>
                        <div onClick={() => handleCreateOptions('pdf')} className='my-2 bg-white p-5 shadow-[0_0_10px_0px_#00000014] hover:shadow-[0_0_10px_0px_#00000054] rounded-lg cursor-pointer w-full sm:w-1/3'>
                            <PaperClipIcon className='h-10 w-10 text-white bg-[#ff8b48] rounded-lg p-2' />
                            <h3 className='text-sm text-black hover:text-primary font-bold py-4'>PDF Upload</h3>
                            <p className='text-xs font-normal'>Provide a PDF file and we'll fetch all the text data inside</p>
                        </div>
                        <div onClick={() => handleCreateOptions('url')} className='my-2 bg-white p-5 shadow-[0_0_10px_0px_#00000014] hover:shadow-[0_0_10px_0px_#00000054] rounded-lg cursor-pointer w-full sm:w-1/3'>
                            <LinkIcon className='h-10 w-10 text-white bg-[#54cd9d] rounded-lg p-2' />
                        ...
                        <div className='shadow-lg w-full sm:w-[700px] h-[100%] relative flex flex-col pl-8 pr-8'>
                            <div className='flex flex-col sm:flex-row gap-2 items-center py-4 border-b border-border dark:bg-gray-800 dark:border-gray-700'>
                                ...
                                <div className='flex flex-row justify-end gap-2'>
                                    ...
                                    <button onClick={(e) => setCreateOptions(null)} type="button" className="flex items-center justify-center gap-2 focus:ring-4 focus:outline-none font-bold rounded-md text-sm py-2.5 px-4 w-auto focus:ring-yellow-300 text-white bg-black hover:text-white hover:bg-[#757575] disabled:bg-input_color disabled:text-white">
                                        Save and close
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className='my-8'>
                                <div className='flex flex-col gap-6'>
                                    ...
                                    <div className='relative pb-6'>
                                        <textarea rows="10" cols="30" className='border-0 shadow-none block px-3 bg-white  rounded-md text-lg placeholder-slate-400 text-black  focus:outline-none focus:border-sky focus:ring-2 placeholder:text-[20px] text-[20px] disabled:bg-slate-50 disabled:text-slate-500 w-full focus:bg-white focus:text-[12px]' placeholder='Start writing your Fin Content...'></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='bg-[#E8E8E8] flex items-start gap-3 py-[10px] px-[15px] rounded-lg absolute bottom-4 left-3 right-3'>
                                <div className="flex gap-3 items-start justify-start">
                                    ...
                                    <p className='font-sm'><span className='font-bold'>Tip:</span> Snippets are exclusive to Fin and not publicly available to your customers. <a href=''>Learn more.</a></p>
                                </div>
                            ...
                            <div className='flex flex-col flex-1 p-0'>
                                <div className='flex flex-col gap-16 border-gray-lightest p-8 -mx-8'>
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <div className='flex flex-col gap-2 pt-2'>
                                            ...
                                            <div class="flex flex-row">
                                                <button type="button" className="flex items-center justify-center gap-2 focus:ring-4 focus:outline-none font-bold rounded-md text-sm py-2.5 px-4 w-auto focus:ring-yellow-300 text-white bg-black hover:text-white hover:bg-[#757575] disabled:bg-input_color disabled:text-white">
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <p class="text font-normal text-xs">
                                            Fin will automatically generate responses using the following external sources:
                                        </p>
            ...
            {createPdfModal === true && (
                <Modal
                    title={<span className='flex items-center justify-center gap-1'><ArrowLeftIcon onClick={(e) => { setCreatePdfModal(false); setCreateModal(true); }} className='w-6 h-6 pr-2 hover:text-primary cursor-pointer' />Add new Fin Content</span>}
                    show={createPdfModal}
                ...
                >
                    <div className=''>
                        <div className='border-b border-gray pb-5'>
                            <h3 className='font-bold my-2'>PDF Upload</h3>
                            <div className='block sm:flex items-center justify-between gap-8'>
                                ...
                                <div className='pt-4 sm:pt-0'>
                                    <ul className='list-disc text-sm'>
                                        <li>Supported format is text PDF in English, up to 45 MB size. Images won't be scraped.</li>
                        ...
                        <div className='py-3'>
                            <button type="button" className="flex items-center justify-center gap-2 focus:ring-4 focus:outline-none font-bold rounded-md text-sm py-2.5 px-4 w-auto focus:ring-yellow-300 text-black bg-[#ececf1] hover:text-primary hover:bg-[#eef0fc] disabled:bg-input_color disabled:text-white">
                                <BookOpenIcon className='h-4 w-4' />
