                                ...
                                <p className="text font-normal text-xs py-2">
                                    {
                                        isLoading === true ? <>Crawl your website to generate sub-pages list.</> :
                                            <>Deflection found <b>{subDomainPages.length} pages</b> on your website into the following categories. You can select which pages to train your bot on. NOTE: You can only train on up to 5 pages at a time.</>
                                    }
                                </p>
