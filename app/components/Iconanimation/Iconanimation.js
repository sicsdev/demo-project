    ...
    <div className="animation_icon_section mx-auto max-w-[90%] py-3 js-show-on-scroll bg:white">
      <div className="grid grid-cols-11 gap-4 justify-center">
        ...
        <div className="col-span-12 sm:col-span-5 bg-gray-300 col_section content">
          ...
          Tempo Chat and Smart Inbox connect to your ticketing system, payment processor, and CRM. Want to learn more about how Tempo can work for your business? Chat with us today.
          </p>
