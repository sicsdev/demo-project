...
const Whyhome = () => {
  ...
  return (
    <div className="bg-white p-0 sm:p-[0px] ">
      <h1 className="mb-5 sm:mt-0 mt-5 text-black px-3  sm:text-center text-2xl sm:text-[38px] font-bold sm:mb-7">
        Why 8x8
      </h1>
          ...
          <div className="max-w-[90%] sm:max-w-[100%] ">
            ...
            <div className="max-w-[1400px] w-full m-auto sm:py-4 sm:px-4 px-3 lg:px-4 relative group">
              <div className="grid grid-cols-1 md:grid-cols-2  sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4  gap-5 sm:gap-12  w-full m-auto sm:py-8 md:py-8 lg:py-8 sm:px-4 lg:px-4">
                {data?.map((ele, key) => (
                  <div
                    className="bg-white flex flex-col justify-between cursor-pointer hover:shadow-lg hover:rounded-[20px] hover:outline hover:bg-white sm:p-[24px] hover:outline-[1px] hover:outline-[black]  transition-transform duration-300 "
          
                    key={key}
                  >
                    <div className="p-0 py-2 sm:p-8 md:py-7 md:px-0 font-bold  sm:text-[24px]  ">
                      {ele.name}
                    </div>
