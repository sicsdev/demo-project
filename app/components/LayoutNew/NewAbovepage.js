        ...
        <div className="relative">
          {loading ? (
              ...
              <div className=" block">
                <div className="!m-auto mr-2 ml-[10px] border-solid  relative w-full sm:h-[383px] mt-5 sm:mt-0 h-[286px] flex shrink-0 items-center justify-center  leading-normal">
                  <div className="video_popup relative">
                    ...
                    <div
              className="flex  px-3 sm:px-[15px] items-center my-8 sm:ml-[62px] cursor-pointer absolute bottom-0 left-[13px] sm:left-[-44px]  bg-[white] p-[5px] rounded-[20px]"
              onClick={() => {
                document.body.classList.add("modal-open");
            ...
            >
              ...
              <p className="font-semibold ml-3 see">Watch 2-minute intro</p>
            </div>
                    <div className="video_popup_cross">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
