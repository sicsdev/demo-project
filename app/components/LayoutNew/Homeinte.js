...
const Homeinte = () => {
  ...
  return (
    <div className=" my-8 icons pt-[1px] sm:pt-8 pb-12 w-full mx-auto shadow-box">
      <div className="sm:mb-8 mx-auto max-w-[90%]">
        <h1 className='text-center text-base sm:text-[42px]  sm:leading-8 my-2 font-[600] sm:my-6 font-base text-[black]' >
