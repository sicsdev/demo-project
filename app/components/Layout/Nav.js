          ...
          <div className='flex-wrap flex md:flex sm:flex lg:flex  items-center  h-[60px]'>
            <div className="relative flex flex-row items-center w-full px-6 sm:px-12 md:px-12 lg:px-12 h-[60px]">
                ...
                <ul className='hidden relative md:flex text-white gap-8 flex-row'>
                    <li className='py-[15px] h-[60px] group relative cursor-pointer hover:border hover:border-b-white hover:border-r-0 hover:border-l-0 hover:border-t-0 '>Products
                        <Card className={'animate-fadeIn w-[800px] hidden group-hover:block absolute top-[61px] bg-white'}>
                            <List className={'grid grid-cols-2 gap-8'} />
                        </Card>
                    </li>
                    <li className='py-[15px] h-[60px] group relative cursor-pointer hover:border hover:border-b-white hover:border-r-0 hover:border-l-0 hover:border-t-0 '>Solutions
                        <Card className={'animate-fadeIn w-[800px] hidden group-hover:block absolute bg-white top-[61px]'}>
                            <List className={'grid grid-cols-2 gap-8'} />
                        </Card>
                    </li>
                    <li className='py-[15px] h-[60px] group relative cursor-pointer hover:border hover:border-b-white hover:border-r-0 hover:border-l-0 hover:border-t-0 '>Pricing
                        <Card className={'animate-fadeIn w-[800px] hidden group-hover:block absolute bg-white top-[61px]'}>
                            <List className={'grid grid-cols-2 gap-8'} />
                        </Card>
                    </li>
                ...
                <div className='hidden md:flex flex-row gap-10 items-center ml-auto'>
                    <Link href={'/login'}> <p className='text-white'>Sign In</p></Link>
                    <Link href={'/free-trial'}>   <button
                        type="button"
