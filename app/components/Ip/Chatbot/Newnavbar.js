            ...
            >
                ...
                <div className="flex-wrap   flex md:flex sm:flex lg:flex  items-center  h-[60px]">
                    <div className="relative    flex flex-row items-center w-full px-6 sm:px-12 md:px-12 lg:px-12 h-[60px]">
                        <div className="relative w-28 h-8 mr-12 cursor-pointer">
                        ...
                        {/* <ul className="hidden relative linkhr md:flex text-black gap-2 flex-row">
                            {nav_links.map((element, key) => (
                                <li
                                    key={key}
                                    className="menus_desk py-[15px] px-[15px] h-[60px] group relative cursor-pointer  hover:border-l-0 hover:border-t-0 "
                                    onMouseEnter={(e) => {
                                        setShowmenu(false);
                                    }}
                                >
                                    <p className="flex relative ">
                                        <a
                                            href={element.link}
                                            className="sm:py-[6px] sm:px-[12px]    "
                                        >
                                            {element.name}

                                        </a> <p className="absolute top-[8px] right-[-15px]">
                                            {element.icon}
                                        </p>
                                    </p>
                    ...
                    */}
                        ...
                        <div className="hidden md:flex flex-row gap-[0.5rem] items-center ml-auto">
                            {/* {profile.email ? (
                                ...
                                <Link href={"/login"}>
                                    {" "}
                                    <p className="text-black sm:py-[6px] sm:px-[12px] border-[2px] border-[#80808038] rounded-xl hover:border-[black]  hover:rounded-[2px] hover:rounded-xl	   ">
                                        Sign In
                                    </p>
                                </Link>
                            )} */}
                ...
                {show === true && (
                    <div className="block md:hidden lg:hidden sm:hidden w-full pb-[20px] ">
                        <Accordian setShow={setShow} nav_links={nav_links} profile={profile} />
                    </div>
                )}
            </nav>
        </>
