  ...
  return (
    <div className="bg-background py-8 ">
      <div className="max-w-[1400px] w-full m-auto sm:py-8 md:py-8 lg:py-8  sm:px-4 px-4 lg:px-4 relative group">
        <h2 className="text-center  text-2xl md:text-h2 lg:text-h2 sm:text-h2 sm:leading-8 my-2 font-clash-semibold text-white">
          ...
          {slides.map((item, key) => (
            ...
            >
              <div className="flex flex-col-reverse sm:flex-row justify-start sm:justify-center items-start sm:items-center gap-4 mb-6 sm:mb-10">
                <h5 className="font-clash-semibold text-xl md:text-h6 sm:leading-2 lg:text-h6 sm:text-h6 text-white js-show-on-scroll">
                  {item.title}
                </h5>
                {item.tag && (
                  <button
              ...
              <div className="flex flex-co justify-start items-center gap-4">
                <p className="text-white font-generalSans-medium text-base sm:text-para opacity-70 js-show-on-scroll">
                  {item.text}
                </p>
              </div>
            </div>
