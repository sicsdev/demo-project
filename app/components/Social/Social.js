...
const Social = () => {
    ...
    return (
        ...
        <div className='my-8  mx-auto max-w-[90%]'>
            <h1 className='text-center font-bold mb-4 sm:mb-0 text-2xl text-blue  md:text-5xl lg:text-5xl sm:text-5xl  js-show-on-scroll '>One platform, infinite possibilities</h1>
