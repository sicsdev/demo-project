        ...
        <div>
            ...
            <div className={`w-full  border-b-2 border-border dark:border-gray-700 flex items-center justify-between mt-2 mb-5`}>
                <ul className="flex flex-nowrap items-center overflow-x-auto sm:flex-wrap -mb-px text-xs font-[500] text-center  text-[#5b5e69]">
                    ...
                    {isAuthorizedUser && < li className={` ${!showAlternatives?.id && tab === 0 ? "boredractive" : 'boredrinactive hover:text-black'}`} onClick={() => { setShowAlternatives({}); setTab(0) }}>
                        <span
                  ...
                  rounded-lg active  group`}
                    ...
                    <li className={`  ${!showAlternatives?.id && tab === 1 ? "boredractive" : 'boredrinactive hover:text-black'}`} onClick={() => { setShowAlternatives({}); setTab(1) }}>
                        <span
                   ...
                   cursor-pointer items-center py-2 px-2 rounded-lg active pl-2 group hover:bg-[#038ff408]`}
                    ...
                    <li className={`hover:text-black  ${!showAlternatives?.id && tab === 2 ? "boredractive" : 'boredrinactive '}`} onClick={() => { setShowAlternatives({}); setTab(2) }}>
                        <span
                  ...
                  rounded-lg active pl-2 group`}
                    ...
                    {showAlternatives?.id &&
                        <li className={`hover:text-black boredractive`}>
                            <span
                                className={`flex justify-start gap-2    hover:bg-[#038ff408] cursor-pointer items-center py-2 px-2  
                  rounded-lg active pl-2 group`}
                                aria-current="page"
                        ...
                        <li className='cursor-pointer'>
                            <form>
                                ...
                                <div className="relative">
                                    ...
                                    }} id="search" className="block w-full p-2 focus:outline-none focus:border-sky focus:ring-2 pr-[25px] text-sm text-gray-900 border border-border !rounded-md" placeholder="Search" required />
