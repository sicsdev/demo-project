                    ...
                    <div className='flex justify-center sm:justify-end md:justify-end lg:justify-end gap-4 items-center p-2 bg-white'>
                        ...
                        {loading ?
                            ...
                            <div className="relative">
                                ...
                                <input type="search" id="search" className="block w-full p-2 focus:outline-none focus:border-sky focus:ring-2 pr-[25px] text-gray-900 border border-border !rounded-md" placeholder="Search" value={search} onChange={(e) => { handleChange(e) }} />
                            </div>
                        }
                    </div>
                    <div>
