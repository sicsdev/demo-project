    ...
    return (
        <div className={`inline  ${labelClassName || ""}`}>
            ...
            <textarea
                ...
                className={`${className} new_input appearance-none block border-[0.2px]  px-3 bg-white  rounded-md text-sm shadow-sm placeholder-slate-400  focus:outline-none focus:border-sky focus:ring-2  disabled:bg-slate-50 disabled:text-slate-50 w-full ${error &&
