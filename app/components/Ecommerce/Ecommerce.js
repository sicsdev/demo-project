    ...
    <div className="mx-auto max-w-[90%] my-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-4">
        {card_data.map((item, index) => (
          <Card
            key={index}
            className={
              "bg-white group mt-8 border border-border cursor-pointer hover:border-1 hover:border-primary"
            }
          >
            <div className="">
              ...
              <h3 className="text-center text-base sm:text-2xl md:text-2xl lg:text-2xl group-hover:text-primary  font-bold text-heading">
                {item.title}
              </h3>
              <svg
        ...
        {small_card_data.map((item, index) => (
          ...
          >
            <div className="">
              ...
              <h3 className="text-center text-base sm:text-xl md:text-xl lg:text-xl group-hover:text-primary mt-5 font-bold text-heading mb-5">
                {item.title}
              </h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {/* <div className="text-center mt-5">
        <Button
          type={"submit"}
          className={
            "px-3 py-[11px]  focus:ring-yellow-300 text-white bg-primary hover:bg-black dark:focus:ring-yellow-900"
          }
        >
