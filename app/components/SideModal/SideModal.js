...
const SideModal = ({ setShow, children, heading }) => {
    return (
        <>
            ...
            <div className={` z-50 overflow-y-scroll w-full sm:w-[800px] p-5 fixed top-0 right-0 h-full m-auto max-h-[100%] bg-white`}>
