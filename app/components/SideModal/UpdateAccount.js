...
const UpdateAccount = ({ setShow, title, text, icon, confirmButtonText }) => {
    return (
        <>
            <div
            ...
            <div
                className={`mt-[63px] sm:mt-0 md:mt-0 lg:mt-0 z-50 sm:w-[25%] w-[100%] p-5 fixed sm:top-[150px] top-16 h-[auto] m-auto max-h-[100%] bg-white rounded-lg sm:right-[0] md:right-[200px] lg:right-[500px] right-0`}
            >
                <div className=''>
                    <div className="flex hover:cursor-pointer items-end justify-end gap-2">
                        <div className="flex justify-end gap-2">
                            <div className="cursor-pointer">
                                <XMarkIcon className="h-8 w-8 rounded-lg text-black p-2" onClick={() => setShow(false)} />
                            </div>
                        </div>
                    </div>
                    <div>
