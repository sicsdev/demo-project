    ...
    const options = {
        ...
        plugins: {
            tooltip: {
                ...
                titleFont: { size: 12 },    // Customize the font size of the title
                bodyFont: { size: 12 },     // Customize the font size of the body
                ...
                callbacks: {
                  ...
                  label: function (context) {
                    ...
                    return `${value} ${label} in ${date}`; // Format the label text
                  },
