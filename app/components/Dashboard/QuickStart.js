...
const QuickStart = () => {
  ...
  const quickStartData1 = [
    {
      ...
      content:
        "Finalize your setup by filling out your business information in your Tempo profile.",
      buttonName: "Complete",
    ...
    },
    {
      ...
      content:
        "After creating your new bot, set its display settings and where you want it to show on your website.",
  ...
  const quickStartData = [
    {
      ...
      content:
        "Enhance your customer service by uploading frequently asked questions to Tempo's Knowledge Base.",
      buttonName: "Upload",
      icon: <BookOpenIcon className="w-5 h-5 " />,
    ...
    },
    {
      ...
      content:
        "Get your team onboard with Tempo to maximize the benefits of automated workflows.",
      buttonName: "Invite",
  ...
  const SideBarRoutes = [
    {
      ...
      icon: (
        <CodeBracketSquareIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      href: "/dashboard/workflow/integrations",
      name: "Integrations",
      icon: (
        <ShareIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      name: "Workflows",
      icon: (
        <BriefcaseIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      icon: (
        <BookOpenIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      href: "/dashboard/knowledge-center",
      name: "Learning Center",
      icon: (
        <AcademicCapIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
    ...
    },
    {
      ...
      name: "Agents",
      icon: (
        <AdjustmentsHorizontalIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      name: "Phone",
      icon: (
        <DevicePhoneMobileIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      href: "/",
    ...
    },
    {
      ...
      name: "Chat Logs",
      icon: (
        <ChartBarIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      name: "Billing",
      icon: (
        <BanknotesIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      href: "/dashboard/billing/usage",
      name: "Usage",
      icon: (
        <CurrencyDollarIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      name: "Billing",
      icon: (
        <WrenchScrewdriverIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      href: "/dashboard/knowledge-center",
    ...
    },
    {
      ...
      name: "Team",
      icon: (
        <UserGroupIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
    {
      ...
      name: "API References",
      icon: (
        <CodeBracketIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
      ),
    },
  ];
  ...
  const findIcon = (route) => {
    ...
    return (
      <CheckBadgeIcon className="mt-2 p-2 w-10 h-10 text-white font-bold rounded-md  bg-sidebar-hover " />
    );
  };
  ...
  return (
    <>
      {skeltonLoading ? (
        <>
          <div className="bg-white w-full  m-auto border rounded-lg border-[#F0F0F1] mt-5 sm:w-[760px] ">
            <div
              className={`py-4 px-6 flex justify-between items-center gap-4 ${
                isExpand === true ? "border-b border-[#F0F0F1]" : ""
              }`}
            >
            ...
            <div
              className={`overflow-hidden ${
                isExpand === true ? "visible h-auto pt-6" : "invisible h-0"
              }`}
          ...
          <div className="bg-[#F8F8F8]  w-full sm:w-[760px]  m-auto border rounded-lg border-[#F0F0F1] mt-5">
        ...
        <>
          <div className="bg-white w-full lg:w-[760px] m-auto border rounded-lg border-[#F0F0F1] mt-5">
            <div
              className={`py-4 flex  justify-between  px-6  items-center gap-4 ${
                isExpand === true ? "border-b border-[#F0F0F1]" : ""
              }`}
            >
                    ...
                    {user?.enterprise?.country === "" && key === 3 ? null : (
                      <div>
                        {setHideShow(key) === true &&
                          (ele.title === "Create Your First Workflow" &&
                          user &&
                          user?.email?.split("@")[1] !== "joinnextmed.com" ? (
                            ""
                          ) : (
                            <div
              ...
              <div className="py-4 px-6">
                ...
                <div className="flex gap-4">
                  {recentlyView.map((ele, key) => (
                    <div
                      className={`${
                        key > 1 && "hidden sm:flex"
                      } sm:w-[200px] flex-col bg-white p-3 border hover:bg-[#151d230a]  shadow-sm hover:border-border  rounded-lg border-[#F0F0F1] mt-5`}
                      key={key}
                    >
                      {ele?.subheading && (
                      ...
                      <Link href={ele.route}>
                        <div className="mt-2">
                          <button
                            className={
                              " border border-border rounded-md bg-sidebarroute text-white py-2 px-6 font-semibold text-xs"
                            }
                          >
                            Manage
                          </button>
