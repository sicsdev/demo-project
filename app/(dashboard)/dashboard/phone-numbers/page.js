        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-5">
            ...
            <input
              ...
              className="py-3  sm:text-[12px] mt-1 undefined block border-[0.2px]  px-3 bg-white  rounded-md text-sm shadow-sm placeholder-slate-400  focus:outline-none focus:border-sky focus:ring-2  disabled:bg-slate-50 disabled:text-slate-500 border-input_color w-full null"
              id="Primary"
              type="text"
              value="New Business"
              name="business_name"
            ...
            {ui == true ? (
              <>
                <div className="flex justify-between items-center my-8">
                  ...
                  <div className="gap-5">
                    <div className="selectdiv">
                      <select className="custom-select mt-1 block w-full px-5  bg-white border  rounded-md text-sm shadow-sm placeholder-slate-400  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500">
                        <option value={""} disabled>
                          Select
                        </option>
