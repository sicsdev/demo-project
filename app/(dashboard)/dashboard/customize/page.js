...
const Page = () => {
  ...
  const [preferences, setPreferences] = useState({
    ...
    message_business_hours:
      "We are currently online. Please leave a message and we will get back to you as soon as possible.",
    chat_title: botDetails.name,
    description: "Chat with us",
    language: "en",
    refund_tolerance: 0,
    thumbnail:
      "https://media-server-dev.usetempo.ai/bots/logos/334-3341544_black-square-logo-square-point-of-sale-logo.jpeg",
  });
      ...
      <div className="">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-around mt-3 gap-4">
          <div className="">
            <div className="mb-4">
              <a
                className="flex justify-start gap-2 items-center px-4 pt-4 text-heading font-bold border-heading rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group"
            ...
            <div className="mt-10" style={{ minWidth: "420px" }}>
              <div className="flex items-center w-full mt-2 gap-2">
                ...
                <div className="flex justify-start w-1/2">
                  <input
                    ...
                    type="text"
                    className="block border-gray-300 rounded-md p-2 items-center"
              ...
              <div className="float-right  mt-10  hidden lg:block absolute ">
          <Button
            type={"button"}
            className="inline-block justify-end font-bold rounded bg-primary px-8 pb-2 pt-3 text-xs  uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]"
          onClick={backTodash}
          >
            Save
          </Button>
              ...
              <div className="widget_container active">
                <div className="header_ChatBotWidget">
                  ...
                  >
                    <img
                      width="20px"
                      src="https://widget-dev.usetempo.ai/v1/assets/img/left-arrow.png"
                    />
                  </div>
                  <div className="profile_photo_container">
                    <img width="45px" src={preferences.thumbnail} />
                  </div>
                  <div>
                    <div>
