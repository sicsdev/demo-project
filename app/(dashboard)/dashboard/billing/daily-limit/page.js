  ...
  return (
    <div>
        ...
        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
          <li className="mr-2">
            <a href="#" className=" flex justify-start gap-2 items-center p-4 text-primary font-bold border-b-2 border-primary rounded-t-lg active  group" aria-current="page">
              <CurrencyDollarIcon className="h-6 w-6 text-gray-500" /> Daily Limit
            </a>
          </li>
      ...
      <div className='w-full sm:w-[60%] md:w-[60%] lg:w-[60%] mx-auto my-5'>
        <h3 className="font-bold text-xl md:text-xl lg:text-xl sm:text-xl sm:leading-none my-2 text-heading">Daily Limit</h3>
        <p className='text-sm my-2'>Manage your company's spend by setting daily limits. Notification emails will be sent to Admins of your organization.

        </p>
        <p className='text-sm'>There may be a delay in enforcing any limits, and you are responsible for any overage incurred.</p>
