    ...
    <>
      ...
      {loading ? (
        ...
        <div>
          {data ? (
            <>
              <div className="bg-white w-full sm:w-2/3 m-auto border  border-[#F0F0F1] rounded-lg mt-5">
                <div
                ...
                >
                  ...
                  <div className="relative px-6">
                    ...
                    <span className="absolute top-[13px] sm:top-[9px] left-[14px] text-[12px] px-6">
                      $
                    </span>
                  </div>

                  <div className="border-b border-[#F0F0F1] px-6 py-4">
                    <Button
                      type={"button"}
