                ...
                {workflowView && show && (
                  ...
                  rounded-lg active  group`}
                        ...
                        <div className="relative mt-3">
                            ...
                            <input type="search" id="search" className="border border-border shadow-none block px-2 bg-white  rounded-md text-lg placeholder-slate-400 text-black  focus:outline-none focus:border-sky focus:ring-2 isabled:bg-slate-50 disabled:text-slate-500 w-full focus:bg-white focus:text-[12px] pl-10" placeholder="Search" value={searchKnowledge} onChange={(e) => { searchFaqs(e) }} />
                        </div>
                                                    ...
                                                    <>
                                                        <div className={`bg-[#96b2ed2e] my-4 rounded-md p-3`}>
                                                            <ul className="text-start py-2 text-sm text-gray-700 ">
                                                                <h1 className="text-xs font-semibold">{defaultTitle} Answer:</h1>
