...
console.log("workFlowData.reccomodation",workFlowData.reccomodation)
    return (
        <SideModal setShow={(t) => {
                            ...
                            <div className="flex justify-between items-center gap-2">
                                {!showRecommendedQuestions &&!subQuestionLoading&& (
                                    <button
                                        ...
                                        type="button"
                                        className="mx-2 my-6 flex items-center justify-center text-xs gap-1 focus:ring-4 focus:outline-none font-bold rounded-md py-2.5 px-4 w-auto focus:ring-yellow-300 bg-primary text-white hover:shadow-[0_8px_9px_-4px_#0000ff8a] disabled:bg-input_color disabled:shadow-none disabled:text-white" 
                                        disabled={answer === ""}>
                                        {loadingChangeAnswer ? (
                                            <>
