                    ...
                    <div className="bg-white w-full  m-auto border rounded-lg border-[#F0F0F1] mt-5 sm:max-w-[900px]">
                        {
                            pageSubLoading ?
                                ...
                                :
                                <div className={`w-full py-4 block sm:flex justify-end  px-6  items-center gap-4 border-b border-[#F0F0F1] `}>
                                    ...
                                    <div className="w-full sm:w-3/4 flex items-center mt-3 sm:mt-0 justify-between sm:justify-end gap-4">
                                        <div className="w-full sm:w-auto flex items-center overflow-x-scroll sm:overflow-x-hidden  schedule justify-end sm:justify-start sm:flex-wrap" style={{ rowGap: "4px" }} >
                                ...
                                {user?.enterprise && !(user.enterprise.domain) &&
                                    <div className='flex justify-center text-primary my-5'>
                                        <small className="text-center text-xs m-auto">
                                            It appears your domain has not been configured yet.
                                            Please visit the <a className='cursor-pointer underline' onClick={() => setTab(1)}>DNS Settings</a> tab to configure your domain.
                                        </small>
                                    </div>
                                }
