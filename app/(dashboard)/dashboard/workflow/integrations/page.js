...
const Page = () => {
  ...
  return (
    <>
      ...
      {integrationModal ?
        <Modal title={'Manage Integration'} show={integrationModal} setShow={setIntegrationModal} className={'w-[80%] h-[50%] sm:h-full md:h-full lg:h-full rounded-lg'} showCancel={true} >
