          ...
          <div className="w-full sm:w-1/2 flex items-center justify-center">
            <div className="  flex-col mt-5  sm:mt-0 lg:mt-0 md:mt-0 px-4 sm:px-8 ">
              ...
              <h3 className="font-bold text-xl md:text-xl lg:text-xl sm:text-xl sm:leading-none my-4 text-heading">
                Bots 🤖 and brains 🧠: The winning combination for customer
                service
              </h3>
              <p className="text-base flex- sm:text-para md:text-para lg:text-para my-4 sm:my-8 font-base text-heading">
                What will the future of customer service look like in the age of
                AI? The reality is that it will require a combination of
                automation and humans – or as we like to say, “bots and brains.”
              </p>
